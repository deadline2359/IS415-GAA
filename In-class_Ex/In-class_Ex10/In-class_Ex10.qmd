...
::: {.callout-tip}
OD_Matrix: dont use road network (takes too long)
- osmr - r packages to use the same thing
...
spread() is out of date. use pivot_wider() instead.
:::
...
distmat_km <- as.matrix(distmat/1000) # from meters to km
```
